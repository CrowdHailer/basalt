defmodule Basalt.EmailAddressTest do
  ...
  test "can be cast as string", %{email_address: {_module, email_address}} do
    assert "test@example.com" == "#{email_address}"
  end

  test "can be cast as string from item", %{email_address: email_address} do
    assert "test@example.com" == "#{email_address.to_string}"
  end
end
